...
if __name__ == "__main__":
    ...
    inst_list = [1000000000, 1000000000, 1000000000, 1000000000, 1000000000, 1000000000, 1000000000, 1000000000, 1000000000]
        ...
        for cpu in cpu_types:
            for mem in mem_ctls:
                run = gem5Run.createSERun(
                    ...
                    'gem5-config-baseline-he/run_micro.py',
                    'results-proj-baseline-he/X86/run_micro/{}/{}/{}'.format(bm,cpu,mem),
