...
for bm in benchmarks: 
    for cpu in plt_gem5_cpus:
        for mem in plt_mem_ctls:
            ...
            gem5GetStat(datadir+"/"+bm+"/"+cpu+"/"+mem,'system.l2cache.overall_misses::total'),
            gem5GetStat(datadir+"/"+bm+"/"+cpu+"/"+mem,'system.l2cache.overall_accesses::total'),
...
print(df)
stat = 'miss_count'
with open('miss_count_dbcp.csv', 'w', newline='') as csvfile:
    header = ['benchmark']
